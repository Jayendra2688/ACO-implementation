...
class Aco:
    ...
    def calculate_passengers(self, path_taken):
        tot_p = 0
        for i in range(len(path_taken)):
            for j in range(i + 1, len(path_taken)):
                ...
                if self.routes_info.get((a, b)) != None:
                    tot_p += self.routes_info.get((a, b))
        return tot_p
    ...
    def update_delta(self, path_taken):
        ...
        tot_passengers = self.calculate_passengers(path_taken)

        print(tot_passengers,len_path)
        delta_p = (tot_passengers) / len_path
    ...
    def optimal_path(self):
        ...
        print(self.calculate_passengers(path))
        return path
