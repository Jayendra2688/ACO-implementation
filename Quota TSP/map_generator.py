...
class Map_generator:
    def __init__(self, cities,quotas,co_ordinates, path_taken):
        self.cities = cities
        self.quotas = quotas
    ...
    def generate_map(self):
        ...
        for i, co_ordinate in enumerate(self.co_ordinates):
            folium.CircleMarker(location=co_ordinate, popup=folium.Popup(f"{self.cities[i],self.quotas[i]}"), radius=3,
        ...
        my_map.save('aco_generated_for_q_tsp.html')
